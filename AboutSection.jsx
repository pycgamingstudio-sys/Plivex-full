...
const PILLARS = [
  {
    ...
    tone: "from-[#6D28D9] to-[#7C3AED]",
    features: [
      "GST & Non-GST invoicing",
      "CGST/SGST/IGST auto-breakup",
      "WhatsApp one-click sharing",
      "Recurring bills & cycles",
      "Credit notes & adjustments",
      "Quotation → invoice convert",
      "HSN autocomplete engine",
      "Multi-currency invoices",
      "Print-perfect A4 PDFs",
  ...
  },
  {
    ...
    tone: "from-[#059669] to-[#10B981]",
    features: [
      "UPI QR code generation",
      "Razorpay checkout",
      "Stripe-ready billing",
      "Partial payment tracking",
      "Expense & purchase ledger",
  ...
  {
    icon: ShieldCheck,
    title: "AI-First Infrastructure & Security",
    tone: "from-[#0D9488] to-[#14B8A6]",
    features: [
  ...
  {
    icon: Plug,
    title: "Usability & Integrations",
    tone: "from-[#DB2777] to-[#EC4899]",
    features: [
      ...
      <div className="overflow-hidden rounded-3xl border border-[#E5E7EB] bg-white shadow-sm">
        <div className="bg-gradient-to-br from-[#6D28D9] to-[#4c1d95] p-6 text-white sm:p-8">
          ...
          <h2 className="mt-2 text-[22px] font-bold leading-tight sm:text-[28px]">
            Ultra-affordable, fast, AI-first B2B SaaS.
          </h2>

          <p className="mt-2 max-w-2xl text-[13px] leading-relaxed text-white/85">
            Plivex is an all-in-one billing & business operating system built
            for Indian SMEs, freelancers and agencies. We pair enterprise-grade
            multi-tenant isolation with a blazing-fast interface so you can
            raise a GST invoice, track a payment, and close your books in under
            two minutes — at a price every business can afford.
          </p>
        ...
        <div className="p-5 sm:p-8">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-[16px] font-bold text-slate-900">
              50+ capabilities across 6 core pillars
            </h3>
          </div>

          <p className="mt-1 text-[12px] text-slate-500">
            Everything you need to run billing, clients, payments, reports,
            security and integrations — in one workspace.
          </p>
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {PILLARS.map((p) => (
              <div
                key={p.title}
                className="rounded-2xl border border-[#E5E7EB] bg-slate-50/60 p-4"
              >
                <div className="flex items-center gap-2.5">
                  <span
                    className={`flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br ${p.tone} text-white`}
                  >
