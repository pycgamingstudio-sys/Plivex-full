...
export function setupVisualEditAgent() {
    ...
    const selectElement = (element, notifyParent = true) => {
        ...
        setTimeout(() => {
            if (selectedElementId === visualSelectorId) {
                ...
                if (selectedElement && !selectedElement.isConnected) {
                    const selectedIndex = selectedElement.dataset.arrIndex;
                    const replacement = currentElements.find((element) => element.dataset.arrIndex === selectedIndex);
                    if (replacement) {
