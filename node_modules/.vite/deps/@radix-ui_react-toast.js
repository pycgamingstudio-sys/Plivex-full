...
import {
  ...
  useLayoutEffect2
} from "./chunk-YQNO6VYF.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-HON6GQSC.js";
import {
  require_react_dom
...
var DismissableLayerBranch = React4.forwardRef(__name3(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React4.useContext(DismissableLayerContext);
...
var ToastProvider = __name7((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React8.forwardRef(
  __name7(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React8.useEffect(() => {
      const handleKeyDown = __name7((event) => {
        var _a2;
    ...
    React8.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name7((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name7(() => {
...
var FocusProxy = React8.forwardRef(
  // blank line to reduce diff noise
  __name7(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React8.forwardRef(
  // blank line to reduce diff noise
  __name7(function Toast2(props, forwardedRef) {
...
var ToastImpl = React8.forwardRef(
  __name7(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name7((props) => {
...
var ToastTitle = React8.forwardRef(
  __name7(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React8.forwardRef(
  // blank line to reduce diff noise
  __name7(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React8.forwardRef(
  __name7(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React8.forwardRef(
  __name7(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React8.forwardRef(__name7(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name7(getAnnounceTextContent, "getAnnounceTextContent");
...
__name7(handleAndDispatchCustomEvent2, "handleAndDispatchCustomEvent");
var isDeltaInDirection = __name7((delta, direction, threshold = 0) => {
...
__name7(useNextFrame, "useNextFrame");
function isHTMLElement(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name7(isHTMLElement, "isHTMLElement");
function getTabbableCandidates(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name7((node) => {
...
__name7(getTabbableCandidates, "getTabbableCandidates");
